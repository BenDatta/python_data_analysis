...
def trips_silver():
    df_bronze = spark.readStream.table("data_projects.bronze.trips")
    ...
    df_silver = df_bronze.select(
        ...
        F.col("bronze_ingest_datetime").alias("bronze_ingest_timestamp"),
    )
...
dp.create_streaming_table(
    name="data_projects.silver.trips",
...
dp.create_auto_cdc_flow(
    target="data_projects.silver.trips",
